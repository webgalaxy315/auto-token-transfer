      ...
      <div className="shane_tm_news bg_red">
          ...
          <div className="news_list">
            <ul>
              ...
              <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="300">
                <div className="list_inner nohighlight">
                  <img src="/img/team/anon3.jpg" alt="Dicaprio" />
                  <div className="details">
                    <h3 className="title">Partnership lead: Dicaprio<br/>(Canada)</h3>
                  </div>
                </div>
              </li>
        ...
        <div className="container">
          ...
          <div className="news_list">
            ...
            <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="300">
                <div className="list_inner nohighlight">
                  <img src="/img/team/anon1.jpg" alt="Sid" />
                  <div className="details">
                    <h3 className="title">Operations lead: Sid<br/>(US)</h3>
                  </div>
                </div>
              </li>
              ...
              <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="150">
                <div className="list_inner nohighlight">
                  <img src="/img/team/anon2.jpg" alt="thumb" />
                  <div className="details">
                    <h3 className="title">Community lead: Miner<br/>(UK)</h3>
                  </div>
                </div>
              </li>
              ...
              <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="150">
                <div className="list_inner nohighlight">
                  <img src="/img/team/christine.jpg" alt="thumb" />
                  <div className="details">
                    <h3 className="title">Marketing lead: Christine<br/>(US)</h3>
                  </div>
                </div>
              </li>
              {/* End single blog */}
        ...
        <div className="container">
          ...
          <div className="news_list">
            ...
            <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="300">
                <div className="list_inner nohighlight">
                  <img src="/img/team/anon1.jpg" alt="Mikey" />
                  <div className="details">
                    <h3 className="title">Marketing lead: Mikey<br/>(NZ)</h3>
                  </div>
                </div>
              </li>
